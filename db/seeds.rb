...
Event.create!(name: "Betriebssysteme", description: "BS", d_start: "2022-01-03 08:00:13", d_end: "2022-01-03 9:58:13", recurring: IceCube::Rule.weekly.day(:monday).to_yaml,  room: seminar_room)
