...
RSpec.describe "/rooms", type: :request do
  ...
  let(:valid_attributes) do
    Room.new(name: "H-2.57", floor: 2, room_type: "seminar-room", location_longitude: 3.5, location_latitude: 1.5, building: create(:building)).attributes
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_room) do
        Room.new(name: "H-E.51", floor: "E", room_type: "seminar-room", location_longitude: 3.5, location_latitude: 1.5, building: create(:building))
      end
