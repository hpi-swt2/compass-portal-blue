...
RSpec.describe "/buildings", type: :request do
  ...
  let(:valid_attributes) do
    Building.new(name: "Main Building", location_longitude: -180, location_latitude: -90, user: FactoryBot.create(:user)).attributes
  end

  let(:invalid_attributes) do
    Building.new(name: "does not exist", location_longitude: -1000, location_latitude: 500, user: FactoryBot.create(:user)).attributes
  end
