...
RSpec.describe "rooms/index", type: :view do
  before do
    ...
    @rooms = Room.create([{ name: "Lecture hall 1", floor: 0, room_type: 
    "lecture-hall", location_latitude: 1.5, location_longitude: 3.5},
                          { name: "H-2.57", floor: 2, room_type: 
                          "seminar-room", location_latitude: 4.5, 
