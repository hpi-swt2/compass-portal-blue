...
RSpec.describe Event, type: :model do
  it "has name, description, start_time, end_time, room, and recurrence rule" do
    ...
    expect(event.start_time).to eq(Time.parse("2021-10-25 13:15:00"))
    expect(event.end_time).to eq(Time.parse("2021-10-25 14:45:00"))
  ...
  context "with recurrence rule" do
    ...
    it "generates calendar events for all occurences in a time frame" do
      ...
      occurence_start_times = ["2021-10-25 13:15:00", "2021-11-01 13:15:00", "2021-11-08 13:15:00"].map {|string| Time.parse(string)}
      occurence_end_times = ["2021-10-25 14:45:00", "2021-11-01 14:45:00", "2021-11-08 14:45:00"].map {|string| Time.parse(string)}
